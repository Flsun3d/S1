...
class ToolHead:
    ...
    def cmd_M100(self, gcmd): #flsun add, shell command
        ...
        command = None
        if sh == 1.0:
            command = ["bash", "/home/pi/flsun_func/Structured_light/move_cali.sh"]
        elif sh == 2.0 and self.struct_light_func:
            command = ["bash", "/home/pi/flsun_func/Structured_light/move_line.sh"]
        elif sh == 3.0:
            command = ["bash", "/home/pi/flsun_func/Structured_light/move_model.sh"]
        elif sh == 4.0 and self.struct_light_func:
            command = ["bash", "/home/pi/flsun_func/Structured_light/move_cube.sh"]
        elif sh == 100.0:
            command = ["bash", "/home/pi/flsun_func/Structured_light/structured_light_video_test.sh"]
